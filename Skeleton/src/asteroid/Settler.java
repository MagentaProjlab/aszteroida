...
public class Settler extends SentientBeing {
	...
	public void Drill() 
	{
		System.out.println("M�g tudja f�rni a telepes?(igen/nem)");
	...
	public void Mine() 
	{
		System.out.println("F�r-e a telepes zseb�be m�g anyag?(igen/nem)");
		Scanner scanner = new Scanner(System.in);
		String input = scanner.nextLine();
	...
	public void PutTeleportGateOnAsteroid() 
	{
		...
		System.out.println("Van-e a telepes zseb�ben teleport?(igen/nem)");
		Scanner scanner = new Scanner(System.in);
		String input = scanner.nextLine();
		if(input.equals("igen")) {
